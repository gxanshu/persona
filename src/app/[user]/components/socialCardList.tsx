...
export const SocialCardList = () => {
  ...
  return (
    <div className="relative flex max-h-[250px] flex-1 flex-col">
      <div
        className="flex flex-1 flex-col overflow-y-auto gap-3 no-scrollbar"
      ...
      <div
        className={`h-[30px] pointer-events-none absolute left-[-0.25rem] right-[-0.25rem] top-[-2px] bg-[linear-gradient(180deg,#fff,hsla(0,0%,100%,0))]`}
        style={{ height: topHeight }}
      >
      </div>
      <div
        className={`h-[42px] pointer-events-none absolute left-[-0.25rem] right-[-0.25rem] bottom-[-2px] bg-[linear-gradient(180deg,hsla(0,0%,100%,0),#fff)] transition-opacity`}
