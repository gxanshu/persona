...
export default function HomeLogin() {
  return (
    <main className="min-h-screen flex flex-col sm:items-center sm:justify-center w-full sm:p-[84px] gap-[56px] sm:gap-[0px]">
      <div className="sm:hidden p-[24px] flex items-center w-full justify-between">
        <Icon
          frameClass="h-[40px] w-[40px]"
          containerClass="h-[44px] w-[44px] flex items-center justify-center"
        >
          <Logo />
        </Icon>
        <div />
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-center sm:gap-[72px] gap-[48px]">
        <div className="hidden sm:block flex max-w-[650px] max-h-[351px] flex-col justify-center">
          <h1
            className={`text-[96px] font-semibold leading-[110%] tracking-[-15.36px] ${lexendGiga.className} text-[#1D1D1F]`}
          >
