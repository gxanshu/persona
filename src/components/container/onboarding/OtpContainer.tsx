	...
	return (
		<div className='flex flex-col gap-[32px] max-w-[390px]'>
			<div className={`flex flex-col gap-[12px] ${lexend.className}`}>
				<h2 className={`text-[#1D1D1F] text-[33px] font-semibold tracking-[-0.66px]`}>Check your phone</h2>
				<p className='text-[#494949] text-[15px] leading-[20px] '>Enter the 6-digit code we texted you</p>
				</div>
