  ...
  return (
    <div className="inline-flex flex-col items-center gap-[48px]">
      ...
      <div className="flex flex-col items-center gap-[24px]">
        ...
        {isFinish ? (<div className="flex items-center gap-[10px]">
            ...
            <button className="p-[12px] bg-gray-50 rounded-full" onClick={() => setIsFinish(false)}>save</button>
          </div>): (isRecording ? (<div className="flex gap-[4px]">
              ...
              </div>): (<button className="p-[12px] bg-[#E71818] rounded-full max-w-max" onClick={startRecording}>
