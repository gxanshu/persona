...
export const CircularProgress = ({total = 0}: CircularProgressProps) => {
	...
	return (
		<svg  width={72} height={72} className="absolute z-[-1]">
			<circle r={33} cx={"35.5px"} cy={"35.5px"} className="fill-none stroke-[4px]" style={{stroke: "#d9d9d9"}}/>
			<circle ref={progressRef} r={33} cx={"35.5px"} cy={"35.5px"} className="fill-none stroke-[4px]" style={{stroke: "#187EE7"}}/>
		</svg>
	)
}