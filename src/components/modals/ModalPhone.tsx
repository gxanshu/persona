    ...
    <div className="flex flex-col items-center justify-between p-[64px] gap-[48px]">
      <div className="flex flex-col gap-[24px] items-center">
        ...
        <div className="flex items-center flex-col gap-[12px]">
          <ListItem emoji="📱" subText="A dedicated number for your users to chat with your Persona. Don’t worry it’s AI managed." />
          <ListItem emoji="🤯" subText="Your Persona can be trained. It can learn from you, and behave like you." />
          <ListItem emoji="💰" subText="Your Persona can be trained. It can learn from you, and behave like you." />
        </div>
      </div>
      <button onClick={() => props.step()} className="p-[12px] flex items-center justify-center rounded-[16px] text-[#1D1D1F] text-[15px] leading-[20px] font-[500] bg-[#F2F2F2] w-full">
        I'm sure
      </button>
    </div>
  );
...
const CardSection: React.FC = () => {
  return (
    <div className="flex flex-col items-center gap-[16px] min-w-[400px]">
      ...
      <p className="w-[90%] text-[#494949] text-[15px] leading-[150%] text-center">A dedicated number for your users to chat with your Persona. Don’t worry it’s AI managed.</p>
    </div>
  );
};
